...
const Productcard = (props : typeprop) => {
    const {image} = props
  return (
    <Link href={"../productdetails"}> <div className=" bg-[#FFFFFF] mb-[50px]">
    <div className={`${image} sm:w-[239px] sm:h-[300px] w-[348px] h-[427px] bg-cover bg-center sm:pt-[123px] sm:pl-[80px] pt-[64px] pl-[92px] `}></div>
